...
namespace OCA\BAV\Toolkit\Service;
...
use OCA\BAV\Toolkit\Backend\ArchiveFormats;
use OCA\BAV\Toolkit\Backend\ArchiveBackend;
use OCA\BAV\Toolkit\Exceptions;
...
class ArchiveService
{
  ...
  use \OCA\BAV\Toolkit\Traits\UtilTrait;
